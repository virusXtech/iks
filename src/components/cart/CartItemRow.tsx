    ...
    <div className="flex flex-col sm:flex-row items-center justify-between py-4 border-b border-border last:border-b-0 gap-4 sm:gap-0">
      <div className="flex items-center gap-4 w-full sm:w-auto">
        ...
        <div className="flex-grow">
          <h3 className="text-lg font-semibold font-serif text-primary">{cartItem.name}</h3>
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <Input
            ...
            min="1"
          />
          <Button variant="outline" size="icon" onClick={() => updateItemQuantity(cartItem.id, cartItem.quantity + 1)}>
