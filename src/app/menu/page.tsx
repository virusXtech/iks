import MenuCategoryDisplay, {
	CategoryIcon,
} from '@/components/menu/MenuCategory';
import {
	Accordion,
	AccordionContent,
	AccordionItem,
...
export default async function MenuPage() {
	...
	try {
		...
		error =
			e instanceof Error
				? e.message
				: 'An unknown error occurred while fetching the menu.';
	}
		...
		return (
			<div className='container mx-auto px-4 py-8'>
				<Alert variant='destructive'>
					...
					<AlertDescription>
						We couldn't load our menu at this time. Please try again later.
						Details: {error}
					</AlertDescription>
				</Alert>
			</div>
		...
		return (
			<div className='container mx-auto px-4 py-8'>
				<Alert>
					...
					<AlertDescription>
						Our menu is currently empty or not available. Please check back
						soon!
					</AlertDescription>
				</Alert>
			</div>
		...
		<div className='space-y-12'>
			<div className='text-center mb-12'>
				...
				<p className='text-xl text-muted-foreground max-w-2xl mx-auto'>
					Discover a symphony of flavors, crafted with the freshest ingredients
