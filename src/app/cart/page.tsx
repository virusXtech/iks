...
export default function CartPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-4xl font-serif font-bold text-primary mb-8 text-center">Your Shopping Cart</h1>
      <Card className="shadow-xl">
        ...
        <CardFooter className="flex flex-col sm:flex-row justify-between items-center gap-4 p-6 bg-muted/30">
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            ...
            <Button variant="outline" onClick={clearCart} className="border-destructive text-destructive hover:bg-destructive/10 w-full sm:w-auto">
              Clear Cart
            </Button>
          </div>
